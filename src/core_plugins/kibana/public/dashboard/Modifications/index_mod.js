...
uiRoutes
  ...
  .when(DashboardConstants.CREATE_NEW_DASHBOARD_URL, {
    ...
    resolve: {
	  ...
	  //Custom function for dashboards references retrieval
	  	  allDash: function (savedDashboards) {
        const list = [];
        return savedDashboards.scanAll().then(function (resp) {
          _.forEach(resp.hits, function (i) {
            list.push(i);
          });
          return list;
        });
