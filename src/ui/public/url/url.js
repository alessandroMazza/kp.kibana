...
export function KbnUrlProvider($injector, $timeout, $location, $rootScope, $parse, Private) {
  /**
  ...
  self.change = function (url, paramObj, appState) {
   $timeout(function(){self._changeLocation('url', url, paramObj, false, appState);;},100)
  };
